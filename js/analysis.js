...
const Analysis = (() => {
  ...
  function pivotCumplimiento(records, reportTypes){
    const users = new Map(); // key -> {usuario, byReport: {type: count}, total, cadenas:Set, puntosVenta:Set, fechas:[]}
    records.forEach(r => {
  ...
  function usuariosBajoVolumen(pivot, umbral){
    return pivot.users
  ...
  return {
    ...
    sugerirUmbralBajoVolumen, usuariosBajoVolumen,
